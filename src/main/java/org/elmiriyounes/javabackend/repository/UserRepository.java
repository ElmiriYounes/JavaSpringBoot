...
public interface UserRepository extends JpaRepository<User, Integer> {
	 ...
	 * findBy{PropertyName}In: findByTitleIn(List<String> titles) = return a
	 * Collection
	 * findBy{PropertyName}Like: findByTitleLike(String title) = return a Collection
	 * findBy{PropertyName}OrderBy{PropertyName}: findByTitleOrderByDateAsc(String
	 * title)
	 ...
	 * existsBy{PropertyName}: existsByTitle(String title) = return true if this
